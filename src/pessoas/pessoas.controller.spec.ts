...
describe('PessoasController', () => {
  ...
  it('create - shoud create a PessoaService', async () => {
  ...
  it('findOne - should find the correct person', async () => {
    const argument = '1';
    const expected = { anyKey: 'anyValue' };
  ...
  it('remove - should remove a person', async () => {
    const argument1 = 1;
  ...
  it('uploadPicture - should upload a picture', async () => {
